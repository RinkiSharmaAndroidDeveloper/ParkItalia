...
/**
 * Created by Android-Dev2 on 7/17/2017.
 */

public class DinningMapActivity  extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dinning_map2);

        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.map1);
        mapFragment.getMapAsync(this);

        findButton = (LinearLayout) findViewById(R.id.find_my_car_layout
        );
        ...
        myAccountButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(DinningMapActivity.this, MyAccount.class);
        ...
        findButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isAlreadyHere) {
                    ...
                    String link6 = "https://maps.googleapis.com/maps/api/directions/json?origin=" + 43.272910 + "," + 11.990023 + "&destination=" + lat + "," + lng + "&mode=car&key=AIzaSyAtUvQTirIhpDUe5XbOHogeSgzFymxv0oc";
                    Log.e("Link 67", link6);
...
// TODO Auto-generated method stub
                    ...
                    Toast.makeText(DinningMapActivity.this, "You are already here", Toast.LENGTH_SHORT).show();
                }
            }
        });
