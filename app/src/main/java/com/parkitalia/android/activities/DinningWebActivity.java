 ...
 */
public class DinningWebActivity extends Activity {
    String url;
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(DinningWebActivity.this, MyAccount.class);
        ...
        findMyCar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(DinningWebActivity.this, DinningMapActivity.class);
