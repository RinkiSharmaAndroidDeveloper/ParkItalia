...
public class ServicesModel {
    ...
    String ImageId,Accomd_name,Accomd_location,Accomd_wevsite,Accomd_phone,image;
    double Accomd_gps_lat,Accomd_gps_lng;


    public ServicesModel(String imageId,String image, String accomd_name, String accomd_location, String accomd_wevsite, String accomd_phone, double Accomd_gps_lat,double Accomd_gps_lng) {
