...
import com.parkitalia.android.adaptors.AccomodationAdapter;
...
public class InformationDetail extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.informationdetailsaccomation);
    ...
    public void getDoctorHistory(){
        ...
        String url2="http://indotesting.com/parkme/webservices/accomo/get_acomo";
        Log.e("usere",url2);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < 9; i++) {
                        ...
                        accomodationModel =new AccomodationModel(id,accomd_type,image,accomd_name,accomd_location,accomd_wevsite,accomd_phone,lat,lng);
...
//                Toast.makeText(Main2Activity.this,"Error"+error.getMessage(),Toast.LENGTH_LONG).show();
    ...
    public void setAdapter(){
        mAdapter = new AccomodationAdapter(InformationDetail.this,accomodationModels);
