...
public class DinningModel {
    ...
    public DinningModel(String imageId,String accomd_type,String image, String accomd_name, String accomd_location, String accomd_wevsite, String accomd_phone, double Accomd_gps_lat,double Accomd_gps_lng) {
