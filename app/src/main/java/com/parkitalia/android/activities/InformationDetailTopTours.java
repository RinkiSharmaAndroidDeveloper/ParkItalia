 ...
 */
public class InformationDetailTopTours extends BaseActivity {
    RecyclerView recyclerView;
    TopTourAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.information_details_top_tours);
    ...
    public void getDoctorHistory(){
        ...
        String url2="http://indotesting.com/parkme/webservices/top_tour/get_tours";
        Log.e("usere",url2);
...
//                Toast.makeText(Main2Activity.this,"Error"+error.getMessage(),Toast.LENGTH_LONG).show();
    ...
    public void setAdapter(){
        mAdapter = new TopTourAdapter(InformationDetailTopTours.this,accomodationModels);
